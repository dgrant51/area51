...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR black][B]Area51[/B][/COLOR][COLOR red]Wizard[/COLOR]'
BUILDERNAME = 'Area51'
EXCLUDES = [ADDON_ID, 'repository.openwizard']
# Text File with build info in it.
BUILDFILE = 'https://dgrant51.github.io/area51/Build%20Resources/buildfile.txt'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Area51[/B][/COLOR][COLOR {color2}]Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing Area51 Wizard.'
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR red][B]Area51[/B][/COLOR]Wizard'
